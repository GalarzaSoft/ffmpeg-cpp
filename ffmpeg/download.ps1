...
(new-object System.Net.WebClient).DownloadFile('https://archive.org/download/zeranoe/win64/dev/ffmpeg-20190716-806ac7d-win64-dev.zip', $devZipPath);
Expand-Archive $devZipPath -DestinationPath $tempPath -Force

(new-object System.Net.WebClient).DownloadFile('https://archive.org/download/zeranoe/win64/shared/ffmpeg-20190716-806ac7d-win64-shared.zip', $binZipPath);
